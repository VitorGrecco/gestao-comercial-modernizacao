...
type
  ...
  public
    ...
    function BuscarClientePorId(AIdCliente: Integer;out ANome: string;out ADocumento: string;out AEmail: string;out ATelefone: string;out AAtivo: Boolean): Boolean;

    procedure InserirCliente(ANome: string;ADocumento: string;AEmail: string;ATelefone: string;AAtivo: Boolean);

    procedure AtualizarCliente(AIdCliente: Integer;ANome: string;ADocumento: string;AEmail: string;ATelefone: string;AAtivo: Boolean);
  end;
